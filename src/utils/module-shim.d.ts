...
declare module "xgplayer/dist/index.js" {
  import XGplayer from "xgplayer";
  export default XGplayer;
}
declare module "xgplayer-hls.js/dist/index.js" {
  import XGplayer from "xgplayer";
  export default XGplayer;
}
declare module "xgplayer-flv.js/dist/index.js" {
  import XGplayer from "xgplayer";
  export default XGplayer;
}
declare module "xgplayer-dash/dist/index.js" {
  import XGplayer from "xgplayer";
  export default XGplayer;
}
declare module "xgplayer-shaka/dist/index.js" {
  import XGplayer from "xgplayer";
  export default XGplayer;
}
declare module "xgplayer-music/dist/index.js" {
  import XGplayer from "xgplayer";
  export default XGplayer;
}
